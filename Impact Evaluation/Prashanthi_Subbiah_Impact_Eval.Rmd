...
# Coding
## Packages
### Important Note: Data from the client is proprietary
...
end_df_3 <- end_df_3 %>%
  mutate(w_index = tot_phq_4 + dep_f + anx_f + pca_locus + pca_internal + pca_external + ladder_now + ladder_five + ladder_change)
...
end_df_updated <- end_df_3 %>%
  select(id, tot_phq_4, dep_f, anx_f, pca_locus, pca_internal, pca_external, ladder_now, ladder_five, ladder_change, control, w_index)

# Renaming to make merger easier
colnames(end_df_updated)
colnames(end_df_updated) <- c("id", "el_tot_phq_4", "el_dep_f", "el_anx_f", "el_pca_locus",  "el_pca_internal", "el_pca_external", "el_ladder_now", "el_ladder_five", "el_ladder_change", "el_control", "el_w_index")
colnames(end_df_updated)
